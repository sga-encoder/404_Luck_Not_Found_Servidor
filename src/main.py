...
# También añadir el directorio src actual
sys.path.append(os.path.dirname(__file__))

try:
    from model.salaDeJuego.juego.KnuckleBones import KnuckleBones
    from model.salaDeJuego.juego.juegosDeCartas.BlackJack import BlackJack
    from model.salaDeJuego.juego.juegosDeCartas.Mazo import Mazo
    from model.salaDeJuego.juego.juegosDeCartas.Poker import Poker
